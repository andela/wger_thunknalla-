    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_start', models.DateField(
                    verbose_name='Start date', blank=True, default=datetime.date.today, null=True)),
                ('date_end', models.DateField(verbose_name='End date', blank=True, null=True)),
                ('email', models.EmailField(
                    verbose_name='Email', blank=True, null=True, max_length=254)),
                ('zip_code', models.CharField(
                    verbose_name='ZIP code', blank=True, null=True, max_length=10)),
                ('city', models.CharField(
                    verbose_name='City', blank=True, null=True, max_length=30)),
                ('street', models.CharField(
                    verbose_name='Street', blank=True, null=True, max_length=30)),
                ('phone', models.CharField(
                    verbose_name='Phone', blank=True, null=True, max_length=20)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name='Contract type', blank=True, null=True, to='gym.ContractType'),),
        migrations.AddField(
            model_name='contract',
            name='member',
            field=models.ForeignKey(
                editable=False, to=settings.AUTH_USER_MODEL, related_name='contract_member'),),
        migrations.AddField(
            model_name='contract',
            name='user',
            field=models.ForeignKey(
