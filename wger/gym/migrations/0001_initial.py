    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(
                    related_name='adminusernote_user', editable=False,
                    to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.CharField(
                    max_length=100, null=True, verbose_name='Owner', blank=True)),
                ('zip_code', models.IntegerField(
                    max_length=5, null=True, verbose_name='ZIP code', blank=True)),
                ('city', models.CharField(
                    max_length=30, null=True, verbose_name='City', blank=True)),
                ('street', models.CharField(
                    max_length=30, null=True, verbose_name='Street', blank=True)),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(
                    related_name='userdocument_member', editable=False,
                    to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(
                    related_name='userdocument_user', editable=False, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-timestamp_created'],
            },
