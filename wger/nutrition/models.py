...
class NutritionPlan(models.Model):
    ...
    def get_nutritional_values(self):
        ...
        '''
        result = cache.get("nutrition-{}".format(self.id))
        ...
        if not result:
            ...
            # set result in cache
            cache.set("nutrition-plan-{}".format(self.id), result)
...
def delete_plan_cache(sender, instance, **kwargs):
    '''
    Delete cache for nutrition
    '''
    cache.delete("nutrition-plan-{}".format(instance.id))
...
class MealItem(models.Model):
    ...
    def get_nutritional_values(self, use_metric=True):
        ...
        if self.ingredient.carbohydrates_sugar:
            nutritional_info[
                'carbohydrates_sugar'] += self.ingredient.carbohydrates_sugar * item_weight / 100
...
def delete_nutrition_cache(sender, instance, **kwargs):
    '''
    Trigger calculation for nutrition plan when meal is added or delete
    '''
    cache.delete("nutrition-plan-{}".format(instance.meal.plan.id))
